...
from custom_data_types import ReportFindings, ReportRecommendations, FollowUpAction
...
# The LLM ignores Pydantic default= values and writes its own disclaimer.
# We force-overwrite here so the product disclaimer is always exact.
_DISCLAIMER: str = (
...
async def generate_recommendations(findings: ReportFindings) -> ReportRecommendations:
    ...
    try:
        ...
        # Force canonical disclaimer — LLM always overwrites the default
